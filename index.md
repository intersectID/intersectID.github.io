...
<div>
    ...
    <ul>        
        <li>Panel Discussion 1: The Role of Technology in Indonesia's Energy Transition</li>
        <li>Panel Discussion 2: Turning Reserves into Resources: How Indonesia Can Lead the Global Energy Transition</li>
...
<div>
    ...
    <ul>
        ...
        <li>
            ...
            <ul>
                <li> Led by Stanford faculty and scholars</li>
                <li> Industry-specific applications of data science</li>
    ...
    <table class="timeline-table">
        ...
        <tbody>
            <tr>
                ...
                <td><span class="date-range">January 1 - May 31, 2025</span></td>
            </tr>
            <tr>
                <td>Call for Papers</td>
                <td><span class="date-range">April 1 - June 30, 2025</span></td>
            </tr>
            <tr>
                <td>Young Researcher Competition</td>
            ...
            <tr class="child-row">
                <td>Early Bird</td>
                <td><span class="date-range">July 1 - August 31, 2025</span></td>
            </tr>
            <tr class="child-row">
                <td>Regular</td>
                <td><span class="date-range">September 1 - October 31, 2025</span></td>
            </tr>
            <tr class="parent-row">
            ...
            <tr class="child-row">
                <td>Early Bird</td>
                <td><span class="date-range">March 1 - June 30, 2025</span></td>
            </tr>
            <tr class="child-row">
                <td>Regular</td>
                <td><span class="date-range">July 1 - October 31, 2025</span></td>
            </tr>
            <tr class="child-row">
                <td>Last-minute</td>
...
<div class="leadership-grid">
    <div class="leader-card">
        ...
        <p class="leader-role">Research Scientist/Engineer</p>
        <p class="leader-affiliation">Stanford Intelligent Systems Lab (SISL) and MineralX, Stanford University</p>
    </div>
