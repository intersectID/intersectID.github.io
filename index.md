...
<div>
    ...
    <div class="speakers-grid">    
        ...
        <div class="speaker-card">
            <div class="speaker-image">
                <img src="/assets/img/hanna-kurniawati.jpg" alt="Hanna Kurniawati">
            </div>
            <h3 class="speaker-name">Hanna Kurniawati</h3>
            <p class="speaker-title">Professor and SmartSat CRC Chair in System Autonomy, Intelligence and Decision Making, ANU</p>
        </div>  
...
<div>
    ...
    <table class="timeline-table">
        ...
        <tbody>
            ...
            <tr class="child-row">
                <td>Early Bird</td>
                <td><span class="date-range">July 1 - September 31, 2025</span></td>
            </tr>
            <tr class="child-row">
                <td>Regular</td>
            ...
            <tr class="child-row">
                <td>Early Bird</td>
                <td><span class="date-range">April 1 - July 30, 2025</span></td>
            </tr>
            <tr class="child-row">
                <td>Regular</td>
                <td><span class="date-range">October 1 - October 31, 2025</span></td>
...
<div class="committee-grid">
    ...
    <div class="committee-section">
        ...
        <ul class="committee-list program-committee">
            ...
            <li class="committee-item">
                <span class="committee-name">Rachman Setiawan</span>
